...
// ============================================================
    ...
    DB.templates.push({
        ...
        options: [
            {
			label: {
				zh: "重心壓低，像貓一樣靜止後猛地側身閃開",
				jp: "重心を落とし、猫のように静止してから素早く横へ跳ぶ",
				kr: "무게중심을 낮추고 고양이처럼 잠시 멈춘 뒤 재빠르게 옆으로 피하다"
			},
			action: "node_next",
			rewards: {
				tags: ["applied_kr001"],
			...
			nextScene: {
				dialogue: [{
					text: {
						zh: "「뒤에 있어」意思是「它就在我後面」。你及時側身，躲過了。",
						jp: "「뒤에 있어」の意味は「それは私の後ろにいる」。とっさに横へ躱した。",
						kr: "「뒤에 있어」는 '그게 내 바로 뒤에 있어'라는 뜻이야. 제때 옆으로 피했다."
					}
				}],
				options: [{ label: { zh: "계속", jp: "続ける", kr: "계속" }, action: "advance_chain" }]
			}
		},
		{
			label: {
			...
			nextScene: {
				dialogue: [{
					text: {
						...
						jp: "ただの幻覚だと思っていた。しかし「뒤에 있어」は「それがすぐ後ろにいる」という意味だった……",
						kr: "그냥 착각이라 여겼다. 하지만 「뒤에 있어」는 '그게 바로 내 뒤에 있어'라는 뜻이었다……"
					}
				}],
